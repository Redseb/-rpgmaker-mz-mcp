...
export const KNOWN_COMMANDS: Record<number, CommandSpec> = {
  ...
  212: { name: 'Show Animation' },
  213: { name: 'Show Balloon Icon' },
  // Screen / audio / timing
  221: { name: 'Fadeout Screen' },
  222: { name: 'Fadein Screen' },
  223: { name: 'Tint Screen' },
  224: { name: 'Flash Screen' },
  225: { name: 'Shake Screen' },
  230: { name: 'Wait', check: expectLength(1) },
  231: { name: 'Show Picture' },
  235: { name: 'Erase Picture' },
  241: { name: 'Play BGM' },
